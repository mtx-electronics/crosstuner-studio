...
IMPLEMENT_APP(CrossTunerStudioApp);

bool CrossTunerStudioApp::OnInit()
{
    //(*AppInitialize
    bool wxsOK = true;
    ...
    if ( wxsOK )
    {
    	CrossTunerStudioFrame* Frame = new CrossTunerStudioFrame(0);
    	Frame->Show();
    	SetTopWindow(Frame);
    }
    //*)
